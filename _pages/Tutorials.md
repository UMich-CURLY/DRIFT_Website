...
<img src="{{ site.url }}/images/measurement.png" alt= measurement style="max-width:85%;height:auto">
...
<img src="{{ site.url }}/images/filter.png" alt= filter style="max-width:85%;height:auto">
...
<img src="{{ site.url }}/images/filterinterface.png" alt= filterinterface style="max-width:85%;height:auto">
...
<img src="{{ site.url }}/images/robotstate.png" alt= rstate style="max-width:85%;height:auto">
...
<img src="{{ site.url }}/images/kin.png" alt= kin style="max-width:85%;height:auto">
...
<img src="{{ site.url }}/images/comm.png" alt= comm style="max-width:85%;height:auto">

Below is DRIFT's flow structure of data input and robot state information output.

<img src="{{ site.url }}/images/flowdiagram.png" alt= flow style="max-width:85%;height:auto">
